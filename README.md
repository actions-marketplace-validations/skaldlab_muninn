...
```bash
go install github.com/skaldlab/muninn@v0.3.5
```
...
```bash
docker buildx imagetools inspect ghcr.io/skaldlab/muninn:0.3.5 \
  --format '{{ json .SBOM }}'
docker buildx imagetools inspect ghcr.io/skaldlab/muninn:0.3.5 \
